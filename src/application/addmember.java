...
public class addmember {
	...
	public static void display() {
	         ...
	         window = new Stage();
		      Label text0 = new Label("ADD MEMBER");
		      ...
		      TextField textField3 = new TextField("@northsouth.edu");
		      ...
		      Button button1 = new Button("Submit");
		             button1.setOnAction(e->{
		            	 if(textField1.getText().isEmpty()||textField2.getText().isEmpty()||textField4.getText().isEmpty()||textField3.getText().isEmpty()) {
		            	  ...
		            	  file.sendfile(textField1.getText(),textField2.getText(),textField3.getText(),textField4.getText());
		            	  window.close();
		            	 heart.display();
		             });
